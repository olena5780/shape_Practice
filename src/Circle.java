...
/*
    ...
    @Override
    public double area() {
        return pi * radius * radius; //Area of a circle can be found as => π * r * r
    }

    @Override
    public double perimeter() {
        return 2 * pi * radius; // Perimeter of a circle can be found as => 2 * π * r
    }
    ...
    public String toString() {
        return getClass().getSimpleName() + "{" +
                "radius=" + radius +
                '}'+
                "\nArea of the " + getClass().getName() + " is = " + area() +"\n" +
                "Perimeter of the " + getClass().getName() + " is = " + perimeter();
    }
}
